                ...
                <div className="app-header-content">
                    <div className="header-left">
                        ...
                        <div className="header-title-group">
                            ...
                            <span className="version-badge">v11.5.0 - GAP ANALYSIS SOTA</span>
                        </div>
                    </div>
                        ...
                        <div className="content-strategy-view">
                            ...
                            <div className="tabs-container">
                                <div className="tabs" role="tablist">
                                    ...
                                    <button className={`tab-btn ${contentMode === 'gapAnalysis' ? 'active' : ''}`} onClick={() => setContentMode('gapAnalysis')} role="tab" style={{color: contentMode === 'gapAnalysis' ? 'var(--accent-primary)' : '#3b82f6', fontWeight: 'bold', border: contentMode === 'gapAnalysis' ? '2px solid var(--accent-primary)' : 'none', borderRadius: '8px', background: contentMode === 'gapAnalysis' ? 'rgba(59, 130, 246, 0.1)' : 'transparent'}}>🚀 AI Gap Analysis</button>
                            ...
                            {contentMode === 'gapAnalysis' && (
                                <div className="tab-panel">
                                    <div style={{display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem'}}>
                                        ...
                                        <div>
                                            <h3 style={{background: 'linear-gradient(to right, #3b82f6, #8b5cf6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: '1.8rem', margin: 0}}>Blue Ocean Gap Analysis</h3>
                                            <p className="help-text" style={{margin: 0}}>Visualize and capture high-traffic opportunities your competitors missed.</p>
                                        </div>
                                    </div>
                                            ...
                                            <button className="btn" onClick={handleAnalyzeGaps} disabled={isAnalyzingGaps} style={{width: '100%', padding: '1rem', fontSize: '1rem'}}>
                                                {isAnalyzingGaps ? (
                                                    <span style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem'}}>
                                                        <span className="spinner" style={{width: '20px', height: '20px'}}></span> Scanning Market Trends (2024-2025)...
                                                    </span>
                                    ...
                                    {gapSuggestions.length > 0 && (
                                        <div className="gap-analysis-results">
                                            <h4 style={{margin: '2rem 0 1rem 0', textTransform: 'uppercase', letterSpacing: '2px', color: '#64748B'}}>Blue Ocean Matrix Results</h4>
                                            <div className="gap-suggestions-grid" style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '1.5rem'}}>
                                                {gapSuggestions.map((suggestion, index) => (
                                                    <div key={index} className="setup-card" style={{
                                                        padding: '1.5rem', 
                                                        display: 'flex', 
                                                        ...
                                                        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start'}}>
                                                            <h4 style={{margin: 0, fontSize: '1.2rem', color: 'white', fontWeight: '700', textShadow: '0 0 10px rgba(59, 130, 246, 0.3)'}}>{suggestion.keyword}</h4>
                                                            <span className={`badge ${suggestion.searchIntent}`} style={{fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.05em', background: 'rgba(59, 130, 246, 0.2)', color: '#60A5FA', border: '1px solid rgba(59, 130, 246, 0.3)'}}>{suggestion.searchIntent}</span>
                                                        </div>
                                                        
                                                        <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', background: 'rgba(0,0,0,0.3)', padding: '0.8rem', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.05)'}}>
                                                            <div>
                                                                <div style={{fontSize: '0.7rem', color: '#94A3B8', textTransform: 'uppercase', marginBottom: '4px'}}>Est. Volume</div>
                                                                <div style={{fontSize: '1.1rem', color: 'white', fontWeight: '700'}}>{suggestion.monthlyVolume || 'N/A'}</div>
                                                            </div>
                                                            <div>
                                                                <div style={{fontSize: '0.7rem', color: '#94A3B8', textTransform: 'uppercase', marginBottom: '4px'}}>Difficulty (KD)</div>
                                                                <div style={{fontSize: '1.1rem', color: suggestion.difficulty === 'Easy' ? '#10B981' : suggestion.difficulty === 'Medium' ? '#F59E0B' : '#EF4444', fontWeight: '700'}}>{suggestion.difficulty || 'Medium'}</div>
                                                            </div>
                                                        </div>

                                                        <div style={{display: 'flex', flexDirection: 'column', gap: '0.5rem'}}>
                                                            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                                                                <span style={{fontSize: '0.8rem', color: '#94A3B8', fontWeight: 'bold'}}>Viral Potential</span>
                                                                <span style={{fontSize: '0.9rem', fontWeight: 'bold', color: suggestion.trendScore > 80 ? '#10B981' : '#F59E0B'}}>{suggestion.trendScore}%</span>
                                                            </div>
                                                            <div style={{height: '8px', width: '100%', background: 'rgba(255,255,255,0.1)', borderRadius: '4px', overflow: 'hidden'}}>
                                                                <div style={{width: `${suggestion.trendScore}%`, height: '100%', background: `linear-gradient(90deg, ${suggestion.trendScore > 80 ? '#10B981' : '#F59E0B'}, ${suggestion.trendScore > 90 ? '#3B82F6' : '#F59E0B'})`, borderRadius: '4px'}}></div>
                                                            </div>
                                                        </div>

                                                        <p style={{fontSize: '0.9rem', color: '#CBD5E1', lineHeight: '1.6', fontStyle: 'italic', borderLeft: '3px solid #3B82F6', paddingLeft: '1rem', margin: '0.5rem 0'}}>
                                                            "{suggestion.rationale}"
                                                        </p>
                                                        
                                                        <button className="btn btn-small" style={{marginTop: 'auto', background: 'rgba(59, 130, 246, 0.1)', border: '1px solid #3B82F6', color: '#60A5FA', fontWeight: '600', padding: '0.8rem'}} onClick={() => handleGenerateGapArticle(suggestion)}>
                                                            ⚡ Generate SOTA Strategy
                                                        </button>
                                                    </div>
                                                ))}
                                            </div>
